    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card class="p-6 flex flex-col">
        ...
        <div class="space-y-3">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=300&auto=format&fit=crop&q=60"
              alt="Atomic Habits"
      ...
      <Card class="p-6 flex flex-col">
        ...
        <div class="space-y-3">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1512820790803-83ca734da794?w=300&auto=format&fit=crop&q=60"
              alt="Filosofi Teras"
              class="w-14 h-20 object-cover rounded-md bg-gray-100 shrink-0 border border-gray-200"
            />
            <div class="flex-1 min-w-0">
